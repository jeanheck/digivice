...
const showPreviousLocation = () => {
  currentLocationIndex.value =
    (currentLocationIndex.value - 1 + props.locations.length) % props.locations.length;
};
  ...
  >
    ...
    >
      ...
      >
        <button
          ...
          :class="
            Number(locationDotIndex) === currentLocationIndex
    ...
    <div class="relative overflow-hidden" :style="mapImageFrameStyle">
      ...
      <div
        ...
        :class="[isWorldMap ? 'w-8 h-8' : 'w-6 h-6 transition-all duration-300']"
        :style="{
          left: activeLocation.coordinates.x + '%',
          top: activeLocation.coordinates.y + '%',
        }"
      >
        ...
        <div
          ...
          :class="
            isWorldMap
              ? 'w-2.5 h-2.5 shadow-[0_0_10px_rgba(0,255,255,1)]'
              : 'w-2 h-2 shadow-[0_0_8px_rgba(0,255,255,1)]'
          "
        />
        <div
