...
const SOURCE_TYPE: DesertAreaTypeViewModel = "noiseDesertS";
...
<template>
  <div
    class="relative flex w-16 h-16 items-center justify-center bg-green-300"
    :class="clickable ? 'cursor-pointer hover:brightness-110' : 'cursor-default'"
    @click="onClick"
  >
    <span
      v-if="displayLabel"
      class="relative z-10 overflow-hidden px-0.0 text-center font-['Exo_2'] font-bold leading-tight text-[11px] text-blue-800"
    >
      {{ displayLabel }}
    </span>
    <span
