...
export class ExperienceProgressBarPresenter {
  ...
  public static getCalculatedExperienceValues(
    ...
    const requiredExperienceForNextLevel = DigimonRepository.getRequiredExperienceForLevel(
      digimonId,
      level + 1,
    );
    const requiredExperienceForCurrentLevel = DigimonRepository.getRequiredExperienceForLevel(
      digimonId,
      level,
    );
    const totalRequiredInThisLevel =
      requiredExperienceForNextLevel - requiredExperienceForCurrentLevel;
