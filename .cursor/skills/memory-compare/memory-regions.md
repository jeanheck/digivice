...
| `0x00042B28` – `0x00042B3E` | Enemy battle strip (near Blast) | `0x42B28` counter; **`0x42B2C` GroupId** (Int16, wired in `EnemyAddresses.json` → `Battle.GroupId`); `0x42B34+` token/level/max HP+MP — does **not** track current HP damage |
